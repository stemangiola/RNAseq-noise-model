...
negBinomial_fit = sampling(negBinomial_model, cores = 4, iter = iterations)
...
dirichlet_multinomial_fit = sampling(dirichlet_multinomial_model, cores = 4, iter = iterations)
...
logNormal_multinomial_fit = sampling(logNormal_multinomial_model, cores = 4, iter = iterations)
...
logStudent_multinomial_fit = sampling(logStudent_multinomial_model, cores = 4, iter = iterations)
