...
compare_data <- tibble(mu = 250, sigma = 1) %>% 
  crossing(tibble(y = seq(from = 0, to = 10000, by = 100))) %>% 
  crossing(tibble(nu = seq(from = -30, to = 30, by = 5)))%>% 
  rowwise() %>%
...
v = 30
sigma = 1
logsumexp(sichel2_lpmf(y = y, mu = mu, v = v, sigma = sigma))
