...
cache_dir = here("local_temp_data","kfold")
...
fits = sampling_multi(models_list, data_list, cache_dir = cache_dir, cores = 6)
```
...
```{r}
kfold_log_lik <- model_names %>% map(function(model_name) { 
...
saveRDS(kfold_log_lik, here("local_temp_data","kfold_log_lik.rds"))
