...
fileConn<-file("~/.R/Makevars")
writeLines(c("CXX14FLAGS += -O3", "CXX14FLAGS += -fPIC", "CXX14FLAGS += -DSTAN_THREADS", "CXX14FLAGS += -pthread"), fileConn)
close(fileConn)
...
#save(fit_MPI, file="fit_MPI_11032019.RData")
Sys.time()
